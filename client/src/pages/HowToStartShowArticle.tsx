  ...
  return <div className="brand-article-page">
    ...
    <main>
      <section className="brand-article-hero">
        ...
        <div className="brand-article-title"><h1>How to Start a Show for Your Brand</h1><div className="brand-article-byline"><span>SGNL Media</span><span>{published}</span><span>5 min read</span></div></div>
