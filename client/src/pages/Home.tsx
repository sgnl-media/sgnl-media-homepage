...
export default function Home() {
  ...
  return <div className="site-shell" id="top">
    ...
    <main>
      ...
      <section className="results section-rule" id="results"><div className="results-intro"><h2>Proof over<br /><em>promises.</em></h2><p>Real accounts, real numbers. Here's what happens when a brand finally gets a system behind its content.</p></div><div className="testimonial-track"><div className="testimonial-slide"><StoryCard /></div></div></section>
