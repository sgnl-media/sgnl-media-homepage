...
export default function Article() {
  ...
  return <main className="editorial-page" id="editorial-article-top">
    ...
    <header className={`editorial-header ${headerHidden ? "is-hidden" : ""} ${progressDocked ? "has-docked-progress" : ""}`}><a href="/" className="editorial-mark">SGNL <span>Media</span></a><span className="editorial-issue">READ THE ROOM / STRATEGY MEMO</span><a className="editorial-back" href="/read-the-room">All articles <ArrowUpRight size={15} /></a></header>
